...
--
-- Host: localhost
-- Generation Time: Nov 20, 2016 at 05:10 PM
...
(62, 'tinymce test fail', 10, 1, '2016-11-16', 0),
...
(2, 'How to make a vanilla cake', '<p>I want to know the procedure for <strong>baking</strong> vanilla cake</p><p>Edited Content</p>', 1, '2016-09-22', 0, 1, 0),
(3, 'Crisp Roasted Potatoes', 'How to make crisp roasted potatoes in microwave', 2, '2016-09-23', 0, 1, 0),
(4, 'Re chill wine', 'Can you re chill wine?', 1, '2016-09-23', 0, 0, 0),
(5, 'Samosa', 'How to make samosa', 1, '2016-09-23', 0, 0, 0),
(6, 'Pumpkin Apple Streusel Muffins', 'How to bake pumpkin muffins in 2 mins', 2, '2016-10-04', 0, 1, 0),
(9, 'Garlic Breads', 'how to make stuffed garlic breads &lt;b&gt;', 1, '2016-10-17', 0, 0, 0),
(10, 'Potato fries', '<p>Where can I <strong>find</strong> the best loaded potato fries in <strong>Norfolk</strong>?</p>', 7, '2016-10-17', 0, 0, 0),
...
(23, 'Best eateries around ODU', 'please suggest some good eateries around ODU', 17, '2016-10-25', 0, 0, 0),
(24, 'This is &lt;b&gt; a question&lt;/b&gt; !', 'This is &lt;b&gt; a question&lt;/b&gt; !', 17, '2016-10-31', 0, 0, 0),
...
INSERT INTO `user` (`uid`, `firstname`, `lastname`, `address`, `email`, `contact`, `username`, `password`, `upic`, `created_on`, `role`) VALUES
(1, 'Kumar', 'Kallepalli', 'Norfolk, VA', 'kkall002@odu.edu', '7072171427', 'kkall002@odu.edu', '1234', '1.jpg', '2016-09-20', 0),
(2, 'Admin', 'admin', 'Norfolk, VA', 'admin@xyz.com', '123-234-34', 'admin', 'cs518pa$$', '2.png', NULL, 1),
(3, 'Justin', 'Brunelle', 'Norfolk, VA', 'jbrun@xyz.com', '342458697', 'jbrunelle', 'M0n@rch$', NULL, NULL, 0),
(4, 'Peter', 'Venkman', 'Norfolk, VA', 'pven@xyz.com', '343453466', 'pvenkman', 'imadoctor', '4.jpg', NULL, 0),
(5, 'Ray', 'stantz', 'Norfolk, VA', 'rstan@xyz.com', '756756645', 'rstantz', '"; INSERT INTO Customers (CustomerName,Address,City) Values(@0,@1,@2); --', '5.jpg', NULL, 0),
(6, 'Dana', 'Barrett', 'Norfolk, VA', 'dbar@xyz.com', '977565645', 'dbarrett', 'fr1ed3GGS', '6.jpg', NULL, 0),
(7, 'Louis', 'tully', 'Norfolk, VA', 'ltul@xyz.com', '5656454343', 'ltully', '<!--<i>', '7.jpg', NULL, 0),
(8, 'Egon ', 'Spengler', 'Norfolk, VA', 'espen@xyz.com', '4564564564', 'espengler', 'don''t cross the streams', '8.jpg', NULL, 0),
(9, 'Janine ', 'Melnitz', 'Norfolk, VA', 'jmel@xyz.com', '6456454578', 'janine', '--!drop tables;', '9.jpg', NULL, 0),
(10, 'Winston ', 'Zeddemore', 'Norfolk, VA', 'wzed@xyz.com', '367786655', 'winston', 'zeddM0r3', '10.jpg', NULL, 0),
(11, 'gozer', 'gozer', 'Norfolk, VA', 'gozer@xyz.com', '7455656454', 'gozer', 'd3$truct0R', NULL, NULL, 0),
(12, 'slimer', 'slimer', 'Norfolk, VA', 'slimer@xyz.com', '7566453453', 'slimer', 'f33dM3', NULL, NULL, 0),
(13, 'Zuul', 'Zuul', 'Norfolk, VA', 'zuul@xyz.com', '365767454', 'zuul', '105"; DROP TABLE', NULL, NULL, 0),
(14, 'keymaster', 'keymaster', 'Norfolk, VA', 'keymas@xyz.com', '423547345', 'keymaster', 'n0D@na', NULL, NULL, 0),
(15, 'gatekeeper', 'gatekeeper', 'Norfolk, VA', 'gatek@xyz.com', '7567238348', 'gatekeeper', '$l0r', NULL, NULL, 0),
(16, 'Stay', 'Puft', 'Norfolk, VA', 'stayp@xyz.com', '723739843', 'staypuft', 'm@r$hM@ll0w', NULL, NULL, 0),
(17, 'Satya', 'Narayan', 'Norfolk, VA', 'satya@xyz.com', '7575757575', 'satya', 'pass123', '17.jpg', '2016-10-19', 0),
(50, 'Maheedhar', 'Gunnam', 'Norfolk, VA', 'mgunn@xyz.com', '956389456', 'maheedhar', '1234', NULL, '2016-10-21', 0),
(55, 'Deepthi', 'Lakshminarayana', 'Norfolk, VA', 'deepthi@xyz.com', '784548743', 'Deepthi', '1234', NULL, '2016-10-21', 0),
(86, 'Surbhi', 'Shankar', 'Norfolk, VA', 'abc@xyz.com', '123-234-34', 'sshankar', 'abcd', '86.jpg', '2016-10-24', 0);
...
--
ALTER TABLE `answers`
  MODIFY `aid` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=65;
--
...
--
ALTER TABLE `votes_ans`
  MODIFY `vid_ans` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=43;
--
